    ...
    namespace autoware_auto
    {
        namespace ffi
        {
            ParkingPlanner::ParkingPlanner(const CfgParkingPlanner &cfg)
            {
                ...
                paramters.push_back(
                    rclcpp::Parameter("vehicle.front_corner_stiffness", cfg.vehicle.front_corner_stiffness));
                paramters.push_back(
                    rclcpp::Parameter("vehicle.rear_corner_stiffness", cfg.vehicle.rear_corner_stiffness));
                ...
                paramters.push_back(
                    rclcpp::Parameter("optimization_weights.steering", cfg.optimization_weights.steering));
                paramters.push_back(
                    rclcpp::Parameter("optimization_weights.throttle", cfg.optimization_weights.throttle));
                paramters.push_back(
                    rclcpp::Parameter("optimization_weights.goal", cfg.optimization_weights.goal));
                ...
                paramters.push_back(
                    rclcpp::Parameter("state_bounds.lower.velocity_mps", cfg.state_bounds.lower.velocity_mps));
                paramters.push_back(
                    rclcpp::Parameter("state_bounds.lower.heading_rad", cfg.state_bounds.lower.heading_rad));
                paramters.push_back(
                    rclcpp::Parameter("state_bounds.lower.steering_rad", cfg.state_bounds.lower.steering_rad));
                ...
                paramters.push_back(
                    rclcpp::Parameter("state_bounds.upper.velocity_mps", cfg.state_bounds.upper.velocity_mps));
                paramters.push_back(
                    rclcpp::Parameter("state_bounds.upper.heading_rad", cfg.state_bounds.upper.heading_rad));
                paramters.push_back(
                    rclcpp::Parameter("state_bounds.upper.steering_rad", cfg.state_bounds.upper.steering_rad));
                paramters.push_back(rclcpp::Parameter(
                    "command_bounds.lower.steering_rate_rps", cfg.command_bounds.lower.steering_rate_rps));
                paramters.push_back(rclcpp::Parameter(
                    "command_bounds.lower.throttle_mps2", cfg.command_bounds.lower.throttle_mps2));
                paramters.push_back(rclcpp::Parameter(
                    "command_bounds.upper.steering_rate_rps", cfg.command_bounds.upper.steering_rate_rps));
                paramters.push_back(rclcpp::Parameter(
                    "command_bounds.upper.throttle_mps2", cfg.command_bounds.upper.throttle_mps2));

                options.parameter_overrides(paramters);
                ptr = std::make_shared<autoware::motion::planning::parking_planner_nodes::ParkingPlannerNode>(
                    options);
